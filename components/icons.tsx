...
export function CompassIcon({ className = "w-10 h-10" }: IconProps) {
  return (
    ...
    >
      ...
      <path d="M14.5 9.5 12.8 14a1 1 0 0 1-.5.5L8 16.5l1.7-4.5a1 1 0 0 1 .5-.5L14.5 9.5Z" />
    </svg>
  );
}

export function ClipboardIcon({ className = "w-10 h-10" }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export function UnpinnedIcon({ className = "w-10 h-10" }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
      ...
      className={className}
    >
      <path d="M12 21s7-6.58 7-11.5A7 7 0 0 0 5 9.5c0 3 1.9 6.13 3.8 8.4" />
      <circle cx="12" cy="9.5" r="2.5" />
      <path d="m3 3 18 18" />
    </svg>
  );
