// Manual, one-shot fetcher for the Virginia Beach SPCA's volunteer
// program pages. Run with `npm run fetch:vbspca`.
//
// The actual fetch/normalize/upsert logic lives in
// lib/ingestion/sources/vbspca.ts, shared with the weekly Vercel cron
// route at app/api/cron/fetch/vbspca/route.ts (dispatched via lib/ingestion/sourceRegistry.ts) — this file is just env
// loading + a CLI-friendly client + printing.

import { existsSync, readFileSync } from "fs";
import { createClient } from "@supabase/supabase-js";
import { runVbspcaFetch } from "../lib/ingestion/sources/vbspca";
