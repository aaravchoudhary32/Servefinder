// Manual, one-shot fetcher for the Foodbank of Southeastern Virginia and
// the Eastern Shore's public volunteer page. Run with
// `npm run fetch:foodbank-seva`.
//
// The actual fetch/normalize/upsert logic lives in
// lib/ingestion/sources/foodbankSeva.ts, shared with the weekly Vercel
// cron route at app/api/cron/fetch/foodbank-seva/route.ts (dispatched via lib/ingestion/sourceRegistry.ts) — this file is
// just env loading + a CLI-friendly client + printing.

import { existsSync, readFileSync } from "fs";
import { createClient } from "@supabase/supabase-js";
import { runFoodbankSevaFetch } from "../lib/ingestion/sources/foodbankSeva";
